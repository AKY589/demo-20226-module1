...
echo "=========================================="
echo "Настройка HQ-RTR (Маршрутизатор главного офиса)"
echo "=========================================="
...
# ens34 - внутренняя сеть HQ (10.0.0.1/24)
...
# Настройка статических маршрутов к филиалу
echo "Настройка маршрутизации..."
cat > /etc/sysconfig/network-scripts/route-ens33 << EOF
192.168.200.0/30 via 192.168.100.1 dev ens33
EOF
